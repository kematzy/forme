...
describe "Forme Sequel::Model BS3 forms" do
  ...
  it "should wrap both inputs if :as=>:radio is used" do
    ...
    # @b.input(:platinum, :as=>:radio).to_s.must_equal '<li class="boolean"><span class="set-label">Platinum</span><label class="option" for="album_platinum_yes"><input id="album_platinum_yes" name="album[platinum]" type="radio" value="t"/> Yes</label><label class="option" for="album_platinum_no"><input checked="checked" id="album_platinum_no" name="album[platinum]" type="radio" value="f"/> No</label></li>'
    @b.input(:platinum, :as=>:radio, :wrapper=>:div, :tag_wrapper=>:span).to_s.must_equal '<div class="boolean"><span class="set-label">Platinum</span><span><label class="option" for="album_platinum_yes"><input id="album_platinum_yes" name="album[platinum]" type="radio" value="t"/> Yes</label></span><span><label class="option" for="album_platinum_no"><input checked="checked" id="album_platinum_no" name="album[platinum]" type="radio" value="f"/> No</label></span></div>'
  end
  ...
  it "should handle errors on radio buttons for boolean fields if :as=>:radio is used" do
    ...
    @b.input(:platinum, :as=>:radio).to_s.must_equal '<span class="set-label">Platinum</span><div class="radio"><label class="option" for="album_platinum_yes"><input id="album_platinum_yes" name="album[platinum]" type="radio" value="t"/> Yes</label></div><div class="has-error radio"><label class="option" for="album_platinum_no"><input checked="checked" class="error" id="album_platinum_no" name="album[platinum]" type="radio" value="f"/> No</label><span class="help-block with-errors">foo</span></div></div>'
    # @b.input(:platinum, :as=>:radio, :tag_wrapper=>:bs3, :wrapper=>nil).to_s.must_equal '<span class="set-label">Platinum</span><div class="radio"><label class="option" for="album_platinum_yes"><input id="album_platinum_yes" name="album[platinum]" type="radio" value="t"/> Yes</label></div><div class="has-error radio"><label class="option" for="album_platinum_no"><input checked="checked" class="error" id="album_platinum_no" name="album[platinum]" type="radio" value="f"/> No</label><span class="help-block with-errors">foo</span></div></div>'
  end
  ...
  it "should handle Raw :label options if :as=>:radio is used" do
    ...
    @b.input(:platinum, :as=>:radio, :label=>'Foo:<br />'.extend(Forme::Raw)).to_s.must_equal '<span class="set-label">Foo:<br /></span><div class="radio"><label class="option" for="album_platinum_yes"><input id="album_platinum_yes" name="album[platinum]" type="radio" value="t"/> Yes</label></div><div class="radio"><label class="option" for="album_platinum_no"><input checked="checked" id="album_platinum_no" name="album[platinum]" type="radio" value="f"/> No</label></div>'
    # @b.input(:platinum, :as=>:radio, :label=>'Foo:<br />'.extend(Forme::Raw),:tag_wrapper=>:bs3, :wrapper=>nil).to_s.must_equal '<span class="set-label">Foo:<br /></span><div class="radio"><label class="option" for="album_platinum_yes"><input id="album_platinum_yes" name="album[platinum]" type="radio" value="t"/> Yes</label></div><div class="radio"><label class="option" for="album_platinum_no"><input checked="checked" id="album_platinum_no" name="album[platinum]" type="radio" value="f"/> No</label></div>'
    ...
    # @b.input(:platinum, :as=>:radio, :label=>'Foo:<br />',:tag_wrapper=>:bs3, :wrapper=>nil).to_s.must_equal '<span class="set-label">Foo:&lt;br /&gt;</span><div class="radio"><label class="option" for="album_platinum_yes"><input id="album_platinum_yes" name="album[platinum]" type="radio" value="t"/> Yes</label></div><div class="radio"><label class="option" for="album_platinum_no"><input checked="checked" id="album_platinum_no" name="album[platinum]" type="radio" value="f"/> No</label></div>'
  end
  ...
  it "should respect :true_label and :false_label options for boolean fields if :as=>:radio is used" do
    ...
    # @b.input(:platinum, :as=>:radio, :true_label=>"Foo", :false_label=>"Bar",:tag_wrapper=>:bs3, :wrapper=>nil).to_s.must_equal '<span class="set-label">Platinum</span><div class="radio"><label class="option" for="album_platinum_yes"><input id="album_platinum_yes" name="album[platinum]" type="radio" value="t"/> Foo</label></div><div class="radio"><label class="option" for="album_platinum_no"><input checked="checked" id="album_platinum_no" name="album[platinum]" type="radio" value="f"/> Bar</label></div>'
  end
  ...
  it "should respect :true_value and :false_value options for boolean fields if :as=>:radio is used" do
    ...
    # @b.input(:platinum, :as=>:radio, :true_value=>"Foo", :false_value=>"Bar", :tag_wrapper=>:bs3, :wrapper=>nil).to_s.must_equal '<span class="set-label">Platinum</span><div class="radio"><label class="option" for="album_platinum_yes"><input id="album_platinum_yes" name="album[platinum]" type="radio" value="Foo"/> Yes</label></div><div class="radio"><label class="option" for="album_platinum_no"><input checked="checked" id="album_platinum_no" name="album[platinum]" type="radio" value="Bar"/> No</label></div>'
  end
  ...
  it "should use a set of radio buttons for many_to_one associations with :as=>:radio option" do
    ...
    @b.input(:artist, :as=>:radio).to_s.must_equal '<span class="set-label">Artist</span><div class="radio"><label class="option" for="album_artist_id_1"><input checked="checked" id="album_artist_id_1" name="album[artist_id]" type="radio" value="1"/> a</label></div><div class="radio"><label class="option" for="album_artist_id_2"><input id="album_artist_id_2" name="album[artist_id]" type="radio" value="2"/> d</label></div>'
    # @b.input(:artist, :as=>:radio, :tag_wrapper=>:bs3, :wrapper=>nil).to_s.must_equal '<span class="set-label">Artist</span><div class="radio"><label class="option" for="album_artist_id_1"><input checked="checked" id="album_artist_id_1" name="album[artist_id]" type="radio" value="1"/> a</label></div><div class="radio"><label class="option" for="album_artist_id_2"><input id="album_artist_id_2" name="album[artist_id]" type="radio" value="2"/> d</label></div>'
    @c.input(:artist, :as=>:radio).to_s.must_equal '<span class="set-label">Artist</span><div class="radio"><label class="option" for="album_artist_id_1"><input id="album_artist_id_1" name="album[artist_id]" type="radio" value="1"/> a</label></div><div class="radio"><label class="option" for="album_artist_id_2"><input checked="checked" id="album_artist_id_2" name="album[artist_id]" type="radio" value="2"/> d</label></div>'
    # @c.input(:artist, :as=>:radio, :tag_wrapper=>:bs3, :wrapper=>nil).to_s.must_equal '<span class="set-label">Artist</span><div class="radio"><label class="option" for="album_artist_id_1"><input id="album_artist_id_1" name="album[artist_id]" type="radio" value="1"/> a</label></div><div class="radio"><label class="option" for="album_artist_id_2"><input checked="checked" id="album_artist_id_2" name="album[artist_id]" type="radio" value="2"/> d</label></div>'
  end
  ...
  it "should handle Raw label for many_to_one associations with :as=>:radio option" do
    ...
    @b.input(:artist, :as=>:radio, :label=>'Foo:<br />'.extend(Forme::Raw)).to_s.must_equal '<span class="set-label">Foo:<br /></span><div class="radio"><label class="option" for="album_artist_id_1"><input checked="checked" id="album_artist_id_1" name="album[artist_id]" type="radio" value="1"/> a</label></div><div class="radio"><label class="option" for="album_artist_id_2"><input id="album_artist_id_2" name="album[artist_id]" type="radio" value="2"/> d</label></div>'
    # @b.input(:artist, :as=>:radio, :label=>'Foo:<br />'.extend(Forme::Raw), :tag_wrapper=>:bs3, :wrapper=>nil).to_s.must_equal '<span class="set-label">Foo:<br /></span><div class="radio"><label class="option" for="album_artist_id_1"><input checked="checked" id="album_artist_id_1" name="album[artist_id]" type="radio" value="1"/> a</label></div><div class="radio"><label class="option" for="album_artist_id_2"><input id="album_artist_id_2" name="album[artist_id]" type="radio" value="2"/> d</label></div>'
    @b.input(:artist, :as=>:radio, :label=>'Foo<br />').to_s.must_equal '<span class="set-label">Foo&lt;br /&gt;</span><div class="radio"><label class="option" for="album_artist_id_1"><input checked="checked" id="album_artist_id_1" name="album[artist_id]" type="radio" value="1"/> a</label></div><div class="radio"><label class="option" for="album_artist_id_2"><input id="album_artist_id_2" name="album[artist_id]" type="radio" value="2"/> d</label></div>'
    # @b.input(:artist, :as=>:radio, :label=>'Foo<br />', :tag_wrapper=>:bs3, :wrapper=>nil).to_s.must_equal '<span class="set-label">Foo&lt;br /&gt;</span><div class="radio"><label class="option" for="album_artist_id_1"><input checked="checked" id="album_artist_id_1" name="album[artist_id]" type="radio" value="1"/> a</label></div><div class="radio"><label class="option" for="album_artist_id_2"><input id="album_artist_id_2" name="album[artist_id]" type="radio" value="2"/> d</label></div>'
  end
  ...
  it "should correctly use the forms wrapper for wrapping radio buttons for many_to_one associations with :as=>:radio option" do
    skip('pending code review / fix by Jeremy Evans')
    # TODO: INCORRECT OUTPUT: The test output is the correct expected BS3 output, but output is not BS3 formatted.
    #       If ':tag_wrapper=>:bs3' is added, then the correct output is produced and test passes.
    #       QUESTION: how to make this the default on a { :config=>:bs3 } form when using { :as=>radio }???
    
    @b = Forme::Form.new(@ab, :config=>:bs3, :wrapper=>:li)
    @b.input(:artist, :as=>:radio).to_s.must_equal '<li class="many_to_one"><span class="set-label">Artist</span><div class="radio"><label class="option" for="album_artist_id_1"><input checked="checked" id="album_artist_id_1" name="album[artist_id]" type="radio" value="1"/> a</label></div><div class="radio"><label class="option" for="album_artist_id_2"><input id="album_artist_id_2" name="album[artist_id]" type="radio" value="2"/> d</label></div></li>'
    # @b.input(:artist, :as=>:radio, :tag_wrapper=>:bs3).to_s.must_equal '<li class="many_to_one"><span class="set-label">Artist</span><div class="radio"><label class="option" for="album_artist_id_1"><input checked="checked" id="album_artist_id_1" name="album[artist_id]" type="radio" value="1"/> a</label></div><div class="radio"><label class="option" for="album_artist_id_2"><input id="album_artist_id_2" name="album[artist_id]" type="radio" value="2"/> d</label></div></li>'
  end

  it "should support custom wrappers for many_to_one associations with :as=>:radio via :tag_wrapper option" do
    @b = Forme::Form.new(@ab, :config=>:bs3, :wrapper=>:li)
    @b.input(:artist, :as=>:radio, :wrapper=>proc{|t, i| i.tag(:div, {}, [t])}, :tag_wrapper=>proc{|t, i| i.tag(:span, {}, [t])}).to_s.must_equal '<div><span class="set-label">Artist</span><span><label class="option" for="album_artist_id_1"><input checked="checked" id="album_artist_id_1" name="album[artist_id]" type="radio" value="1"/> a</label></span><span><label class="option" for="album_artist_id_2"><input id="album_artist_id_2" name="album[artist_id]" type="radio" value="2"/> d</label></span></div>'
  end
  ...
  it "should handle an error message on the underlying column for pg_array_to_many associations" do
    ...
    #       If ':tag_wrapper=>:bs3' is added, then the correct output is produced and test passes.
    #       QUESTION: how to make this the default on a { :config=>:bs3 } form when using { :as=>radio }???
    #       Additionally: the classes in '<div class="checkbox has-error">' are not joined into a single class statement 
    #
    @ab.errors.add(:atag_ids, 'tis not valid')
    @b.input(:atags).to_s.must_equal '<div class="form-group pg_array_to_many"><label for="album_atag_ids">Atags</label> <select class="form-control error" id="album_atag_ids" multiple="multiple" name="album[atag_ids][]"><option selected="selected" value="1">s</option><option selected="selected" value="2">t</option><option value="3">u</option></select><span class="help-block with-errors">tis not valid</span></div>'
    @b.input(:atags, :as=>:checkbox).to_s.must_equal '<div class="form-group pg_array_to_many"><span class="set-label">Atags</span><div class="checkbox"><label class="option" for="album_atag_ids_1"><input checked="checked" id="album_atag_ids_1" name="album[atag_ids][]" type="checkbox" value="1"/> s</label></div><div class="checkbox"><label class="option" for="album_atag_ids_2"><input checked="checked" id="album_atag_ids_2" name="album[atag_ids][]" type="checkbox" value="2"/> t</label></div><div class="checkbox has-error"><label class="option" for="album_atag_ids_3"><input class="error" id="album_atag_ids_3" name="album[atag_ids][]" type="checkbox" value="3"/> u</label><span class="help-block with-errors">tis not valid</span></div></div></div>'
    # @b.input(:atags, :as=>:checkbox, :tag_wrapper=>:bs3).to_s.must_equal '<div class="form-group pg_array_to_many"><span class="set-label">Atags</span><div class="checkbox"><label class="option" for="album_atag_ids_1"><input checked="checked" id="album_atag_ids_1" name="album[atag_ids][]" type="checkbox" value="1"/> s</label></div><div class="checkbox"><label class="option" for="album_atag_ids_2"><input checked="checked" id="album_atag_ids_2" name="album[atag_ids][]" type="checkbox" value="2"/> t</label></div><div class="checkbox has-error"><label class="option" for="album_atag_ids_3"><input class="error" id="album_atag_ids_3" name="album[atag_ids][]" type="checkbox" value="3"/> u</label><span class="help-block with-errors">tis not valid</span></div></div></div>'
  end
  ...
  it "should use multiple checkboxes for one_to_many associations if :as=>:checkbox" do
    ...
    # TODO: INCORRECT OUTPUT: The test output is the correct expected BS3 output, but output is not BS3 formatted.
    #       If ':tag_wrapper=>:bs3' is added, then the correct output is produced and test passes.
    #       QUESTION: how to make this the default on a { :config=>:bs3 } form when using { :as=>checkbox }???
    
    @b.input(:tracks, :as=>:checkbox).to_s.must_equal '<div class="form-group one_to_many"><span class="set-label">Tracks</span><div class="checkbox"><label class="option" for="album_track_pks_1"><input checked="checked" id="album_track_pks_1" name="album[track_pks][]" type="checkbox" value="1"/> m</label></div><div class="checkbox"><label class="option" for="album_track_pks_2"><input checked="checked" id="album_track_pks_2" name="album[track_pks][]" type="checkbox" value="2"/> n</label></div><div class="checkbox"><label class="option" for="album_track_pks_3"><input id="album_track_pks_3" name="album[track_pks][]" type="checkbox" value="3"/> o</label></div></div>'
    # @b.input(:tracks, :as=>:checkbox, :tag_wrapper=>:bs3).to_s.must_equal '<div class="form-group one_to_many"><span class="set-label">Tracks</span><div class="checkbox"><label class="option" for="album_track_pks_1"><input checked="checked" id="album_track_pks_1" name="album[track_pks][]" type="checkbox" value="1"/> m</label></div><div class="checkbox"><label class="option" for="album_track_pks_2"><input checked="checked" id="album_track_pks_2" name="album[track_pks][]" type="checkbox" value="2"/> n</label></div><div class="checkbox"><label class="option" for="album_track_pks_3"><input id="album_track_pks_3" name="album[track_pks][]" type="checkbox" value="3"/> o</label></div></div>'
    @c.input(:tracks, :as=>:checkbox).to_s.must_equal '<div class="form-group one_to_many"><span class="set-label">Tracks</span><div class="checkbox"><label class="option" for="album_track_pks_1"><input id="album_track_pks_1" name="album[track_pks][]" type="checkbox" value="1"/> m</label></div><div class="checkbox"><label class="option" for="album_track_pks_2"><input id="album_track_pks_2" name="album[track_pks][]" type="checkbox" value="2"/> n</label></div><div class="checkbox"><label class="option" for="album_track_pks_3"><input checked="checked" id="album_track_pks_3" name="album[track_pks][]" type="checkbox" value="3"/> o</label></div></div>'
    # @c.input(:tracks, :as=>:checkbox, :tag_wrapper=>:bs3).to_s.must_equal '<div class="form-group one_to_many"><span class="set-label">Tracks</span><div class="checkbox"><label class="option" for="album_track_pks_1"><input id="album_track_pks_1" name="album[track_pks][]" type="checkbox" value="1"/> m</label></div><div class="checkbox"><label class="option" for="album_track_pks_2"><input id="album_track_pks_2" name="album[track_pks][]" type="checkbox" value="2"/> n</label></div><div class="checkbox"><label class="option" for="album_track_pks_3"><input checked="checked" id="album_track_pks_3" name="album[track_pks][]" type="checkbox" value="3"/> o</label></div></div>'
  end
  ...
  it "should use multiple checkboxes for many_to_many associations if :as=>:checkbox" do
    ...
    @b.input(:tags, :as=>:checkbox).to_s.must_equal '<div class="form-group many_to_many"><span class="set-label">Tags</span><div class="checkbox"><label class="option" for="album_tag_pks_1"><input checked="checked" id="album_tag_pks_1" name="album[tag_pks][]" type="checkbox" value="1"/> s</label></div><div class="checkbox"><label class="option" for="album_tag_pks_2"><input checked="checked" id="album_tag_pks_2" name="album[tag_pks][]" type="checkbox" value="2"/> t</label></div><div class="checkbox"><label class="option" for="album_tag_pks_3"><input id="album_tag_pks_3" name="album[tag_pks][]" type="checkbox" value="3"/> u</label></div></div>'
    # @b.input(:tags, :as=>:checkbox, :tag_wrapper=>:bs3).to_s.must_equal '<div class="form-group many_to_many"><span class="set-label">Tags</span><div class="checkbox"><label class="option" for="album_tag_pks_1"><input checked="checked" id="album_tag_pks_1" name="album[tag_pks][]" type="checkbox" value="1"/> s</label></div><div class="checkbox"><label class="option" for="album_tag_pks_2"><input checked="checked" id="album_tag_pks_2" name="album[tag_pks][]" type="checkbox" value="2"/> t</label></div><div class="checkbox"><label class="option" for="album_tag_pks_3"><input id="album_tag_pks_3" name="album[tag_pks][]" type="checkbox" value="3"/> u</label></div></div>'
    @c.input(:tags, :as=>:checkbox).to_s.must_equal '<div class="form-group many_to_many"><span class="set-label">Tags</span><div class="checkbox"><label class="option" for="album_tag_pks_1"><input id="album_tag_pks_1" name="album[tag_pks][]" type="checkbox" value="1"/> s</label></div><div class="checkbox"><label class="option" for="album_tag_pks_2"><input checked="checked" id="album_tag_pks_2" name="album[tag_pks][]" type="checkbox" value="2"/> t</label></div><div class="checkbox"><label class="option" for="album_tag_pks_3"><input id="album_tag_pks_3" name="album[tag_pks][]" type="checkbox" value="3"/> u</label></div></div>'
    # @c.input(:tags, :as=>:checkbox, :tag_wrapper=>:bs3).to_s.must_equal '<div class="form-group many_to_many"><span class="set-label">Tags</span><div class="checkbox"><label class="option" for="album_tag_pks_1"><input id="album_tag_pks_1" name="album[tag_pks][]" type="checkbox" value="1"/> s</label></div><div class="checkbox"><label class="option" for="album_tag_pks_2"><input checked="checked" id="album_tag_pks_2" name="album[tag_pks][]" type="checkbox" value="2"/> t</label></div><div class="checkbox"><label class="option" for="album_tag_pks_3"><input id="album_tag_pks_3" name="album[tag_pks][]" type="checkbox" value="3"/> u</label></div></div>'
  end
  ...
  it "should handle Raw label for associations with :as=>:checkbox" do
    ...
    @b.input(:tracks, :as=>:checkbox, :label=>'Foo<br />:'.extend(Forme::Raw)).to_s.must_equal '<div class="form-group one_to_many"><span class="set-label">Foo<br />:</span><div class="checkbox"><label class="option" for="album_track_pks_1"><input checked="checked" id="album_track_pks_1" name="album[track_pks][]" type="checkbox" value="1"/> m</label></div><div class="checkbox"><label class="option" for="album_track_pks_2"><input checked="checked" id="album_track_pks_2" name="album[track_pks][]" type="checkbox" value="2"/> n</label></div><div class="checkbox"><label class="option" for="album_track_pks_3"><input id="album_track_pks_3" name="album[track_pks][]" type="checkbox" value="3"/> o</label></div></div>'
    # @b.input(:tracks, :as=>:checkbox, :label=>'Foo<br />:'.extend(Forme::Raw), :tag_wrapper=>:bs3).to_s.must_equal '<div class="form-group one_to_many"><span class="set-label">Foo<br />:</span><div class="checkbox"><label class="option" for="album_track_pks_1"><input checked="checked" id="album_track_pks_1" name="album[track_pks][]" type="checkbox" value="1"/> m</label></div><div class="checkbox"><label class="option" for="album_track_pks_2"><input checked="checked" id="album_track_pks_2" name="album[track_pks][]" type="checkbox" value="2"/> n</label></div><div class="checkbox"><label class="option" for="album_track_pks_3"><input id="album_track_pks_3" name="album[track_pks][]" type="checkbox" value="3"/> o</label></div></div>'
    @b.input(:tracks, :as=>:checkbox, :label=>'Foo<br />').to_s.must_equal '<div class="form-group one_to_many"><span class="set-label">Foo&lt;br /&gt;</span><div class="checkbox"><label class="option" for="album_track_pks_1"><input checked="checked" id="album_track_pks_1" name="album[track_pks][]" type="checkbox" value="1"/> m</label></div><div class="checkbox"><label class="option" for="album_track_pks_2"><input checked="checked" id="album_track_pks_2" name="album[track_pks][]" type="checkbox" value="2"/> n</label></div><div class="checkbox"><label class="option" for="album_track_pks_3"><input id="album_track_pks_3" name="album[track_pks][]" type="checkbox" value="3"/> o</label></div></div>'
    # @b.input(:tracks, :as=>:checkbox, :label=>'Foo<br />', :tag_wrapper=>:bs3).to_s.must_equal '<div class="form-group one_to_many"><span class="set-label">Foo&lt;br /&gt;</span><div class="checkbox"><label class="option" for="album_track_pks_1"><input checked="checked" id="album_track_pks_1" name="album[track_pks][]" type="checkbox" value="1"/> m</label></div><div class="checkbox"><label class="option" for="album_track_pks_2"><input checked="checked" id="album_track_pks_2" name="album[track_pks][]" type="checkbox" value="2"/> n</label></div><div class="checkbox"><label class="option" for="album_track_pks_3"><input id="album_track_pks_3" name="album[track_pks][]" type="checkbox" value="3"/> o</label></div></div>'
  end
  ...
  it "should correctly use the forms wrapper for wrapping radio buttons for one_to_many associations with :as=>:checkbox option" do
    ...
    @b = Forme::Form.new(@ab, :config=>:bs3, :wrapper=>:li)
    @b.input(:tracks, :as=>:checkbox).to_s.must_equal '<li class="one_to_many"><span class="set-label">Tracks</span><div class="checkbox"><label class="option" for="album_track_pks_1"><input checked="checked" id="album_track_pks_1" name="album[track_pks][]" type="checkbox" value="1"/> m</label></div><div class="checkbox"><label class="option" for="album_track_pks_2"><input checked="checked" id="album_track_pks_2" name="album[track_pks][]" type="checkbox" value="2"/> n</label></div><div class="checkbox"><label class="option" for="album_track_pks_3"><input id="album_track_pks_3" name="album[track_pks][]" type="checkbox" value="3"/> o</label></div></li>'
    # @b.input(:tracks, :as=>:checkbox, :tag_wrapper=>:bs3).to_s.must_equal '<li class="one_to_many"><span class="set-label">Tracks</span><div class="checkbox"><label class="option" for="album_track_pks_1"><input checked="checked" id="album_track_pks_1" name="album[track_pks][]" type="checkbox" value="1"/> m</label></div><div class="checkbox"><label class="option" for="album_track_pks_2"><input checked="checked" id="album_track_pks_2" name="album[track_pks][]" type="checkbox" value="2"/> n</label></div><div class="checkbox"><label class="option" for="album_track_pks_3"><input id="album_track_pks_3" name="album[track_pks][]" type="checkbox" value="3"/> o</label></div></li>'
  end

  it "should support custom wrappers for one_to_many associations with :as=>:checkbox via :tag_wrapper option" do
    @b = Forme::Form.new(@ab, :config=>:bs3, :wrapper=>:li)
    @b.input(:tracks, :as=>:checkbox, :wrapper=>proc{|t, i| i.tag(:div, i.opts[:wrapper_attr], [t])}, :tag_wrapper=>proc{|t, i| i.tag(:span, {}, [t])}).to_s.must_equal '<div class="one_to_many"><span class="set-label">Tracks</span><span><label class="option" for="album_track_pks_1"><input checked="checked" id="album_track_pks_1" name="album[track_pks][]" type="checkbox" value="1"/> m</label></span><span><label class="option" for="album_track_pks_2"><input checked="checked" id="album_track_pks_2" name="album[track_pks][]" type="checkbox" value="2"/> n</label></span><span><label class="option" for="album_track_pks_3"><input id="album_track_pks_3" name="album[track_pks][]" type="checkbox" value="3"/> o</label></span></div>'
  end
